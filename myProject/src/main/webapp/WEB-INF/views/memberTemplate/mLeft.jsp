...
<li>
	...
	<li><a href="${pageContext.request.contextPath}/member/ticket.do"></a>이용권 구매<li>
	<li><a href="${pageContext.request.contextPath}/member/deleteMember.do">회원 탈퇴</a><li>
	<li><a href="${pageContext.request.contextPath}/?????"></a>나의 문의내역</li>
	<li><a href="${pageContext.request.contextPath}/?????"></a>나의 찜 목록</li>
